...
function meera_enqueues() {
	...
	wp_register_style('menu-css', get_template_directory_uri() . '/assets/css/menu.css', false, null);
  ...
  wp_register_script('bootstrap-js', 'https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.0.0-beta/js/bootstrap.min.js', false, '4.0.0-beta', true);
	...
	wp_register_script('responsive-nav-js', get_template_directory_uri() . '/assets/js/responsive-nav.js', false, null, true);
	wp_enqueue_script('responsive-nav-js');
